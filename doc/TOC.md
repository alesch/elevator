## Available documents ([`doc/`](doc/))

- [architecture.md](doc/architecture.md) — System architecture overview
- [ci_cd_pipeline.md](doc/ci_cd_pipeline.md) — CI/CD and deployment configuration
- [pending.md](doc/pending.md) — Future improvements
- [simulation.md](doc/simulation.md) — Simulation design and mechanics

**[agents/](doc/agents/)** — Guides for agents
- [README_agents.md](doc/agents/README-agents.md) — General rules.
- [Dev_agents.md](doc/agents/Dev_agents.md) — Development agent roles
- [GUI_agents.md](doc/agents/GUI_agents.md) — UI/Frontend agent roles
- [Bug_Reporting.md](doc/agents/Bug_Reporting.md) — Bug reporting procedure
...
- [motor.md](doc/components/hardware/motor.md) — Motor component
...
- [gherkin_library.md](doc/specs/gherkin_library.md) — Gherkin syntax and patterns
